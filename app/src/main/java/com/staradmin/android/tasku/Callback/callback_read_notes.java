...
public class callback_read_notes extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_notes(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1417002/mst_read_notes.php",
                "POST", paramsed);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    map.put("id_notes", c.getString("id_notes"));
                    map.put("notes_title", c.getString("notes_title"));
                    map.put("isi_notes", c.getString("isi_notes"));
                    map.put("time_upload", c.getString("time_upload"));
