...
public class callback_notes extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_notes(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("title", params[1])); //title
        paramsed.add(new BasicNameValuePair("content", params[2])); //content
        paramsed.add(new BasicNameValuePair("date", params[3])); //date


        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1417002/mst_create_notes.php",
                "POST", paramsed);
