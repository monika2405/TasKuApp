...
public class callback_read_book extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    ...
    public callback_read_book(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1417002/mst_read_book.php",
                "POST", paramsed);
