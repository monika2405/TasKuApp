...
public class callback_delete_notes extends AsyncTask<String, String, ArrayList<HashMap<String, String>>> {
    Context context;
    int success;
    String message;
    ...
    public callback_delete_notes(Context m_context) {
    ...
    protected ArrayList<HashMap<String, String>> doInBackground(String... params) {
        ...
        paramsed.add(new BasicNameValuePair("id_notes", params[0])); //id


        JSONObject json = jsonParser.makeHttpRequest("http://dev.projectlab.co.id/mit/1417002/mst_delete_notes.php",
                "POST", paramsed);
